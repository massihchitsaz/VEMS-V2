...
export function PlatformShell({children}:{children:React.ReactNode}){
 ...
 const sidebar=<aside className="flex h-full w-[280px] flex-col border-r border-slate-800 bg-[#08101f]">
  <div className="flex h-20 items-center border-b border-slate-800 px-5"><Link href="/" className="flex items-center gap-3"><img src="/vtc-group-logo.svg" alt="VTC Group" className="h-11 w-16 object-contain"/><span><span className="block font-bold text-white">VTC ONE</span><span className="block text-xs text-slate-500">Enterprise Operations Platform</span></span></Link></div>
